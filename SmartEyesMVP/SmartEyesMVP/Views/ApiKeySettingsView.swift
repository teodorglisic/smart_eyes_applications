...
/// "API & Model Settings" sheet, opened from the Setup tab. The API key itself is managed by
/// Firebase (via GoogleService-Info.plist) and never entered here — this screen only lets the
/// user pick which Gemini/Gemma model to target, from `GeminiModel.all` (see
